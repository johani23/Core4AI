...
/**
 * Core4.AI – MVP 15 Unified Stats v2
  ...
  if (!stats) {
    return (
      <div className="p-10 text-red-400 text-center bg-black min-h-screen">
        <p>⚠️ Failed to load stats. Try again later.</p>
      </div>
    );
  }

  const cards = [
    { label: "Users", value: stats.total_users, icon: "👥", color: "from-purple-500 to-indigo-600" },
    { label: "Posts", value: stats.total_posts, icon: "📝", color: "from-yellow-500 to-orange-600" },
    { label: "Votes", value: stats.total_votes, icon: "🔥", color: "from-pink-500 to-red-600" },
    { label: "Clusters", value: stats.total_clusters, icon: "🌐", color: "from-blue-500 to-cyan-600" },
    { label: "Wallets", value: stats.total_wallets, icon: "💰", color: "from-green-500 to-emerald-600" },
    { label: "Influence Links", value: stats.influence_links, icon: "⚡", color: "from-indigo-500 to-purple-600" },
  ];

  return (
    <div className="p-8 bg-black min-h-screen text-white">
      <h1 className="text-3xl font-bold mb-6 text-purple-400">📊 Core4.AI System Overview</h1>
