// ============================================================================
// ðŸ’Ž Core4.AI â€“ SocialFeed.jsx (UTF-8 Clean Noor FIX v4)
// ----------------------------------------------------------------------------
// â€¢ Displays posts with likes, comments, merchant offers
// â€¢ Role-aware contextual create button
// ============================================================================
...
export default function SocialFeed({ userRole = "creator" }) {
  ...
  const handleComment = (id) => {
    const t = commentText[id];
    if (!t?.trim()) return;
    addComment(id, t.trim());
          ...
          >
            ...
            {post.merchant && (
              <div className="bg-purple-800/20 border border-purple-700 rounded-lg p-3 mb-4 flex justify-between items-center">
                ...
                <button
                  onClick={() => alert(`ðŸ›’ Buying ${post.merchant}`)}
            ...
            <div className="flex items-center gap-4 mb-2">
              <button
                ...
                className="text-pink-400 text-sm hover:scale-110 transition"
              >
                â¤ï¸ {post.likes || 0}
              </button>
            ...
            {post.comments?.length > 0 && (
              <div className="mt-3 space-y-1">
                {post.comments.map((c, i) => (
                  <div
                    key={i}
                    className="text-gray-400 text-sm bg-black/20 rounded-md px-3 py-1"
                  >
                    {c}
                  </div>
                ))}
