// ============================================================================
// ðŸ’Ž Core4.AI â€“ PromoterDashboard.jsx (v3.1 â€” Fixed by Noor)
// ============================================================================
...
// âŒ FILE NOT FOUND â€” SubTribePanel removed
  ...
  return (
    <div className="min-h-screen bg-[#0A0F12] text-white p-8 space-y-10">
      ...
      <CoreHeader
        ...
        subtitle="Manage orders, commissions, and Sub-Tribe performance"
        icon="ðŸ§©"
      />
      ...
      <CorePanel>
        ...
        {notice && <p className="text-sm text-gray-300 mt-4">{notice}</p>}
      </CorePanel>
