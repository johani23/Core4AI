// ============================================================================
// ðŸ’š OpportunityScore.js (v1.0 BETA)
// ----------------------------------------------------------------------------
// â€¢ Computes Opportunity Score (0â€“100)
// â€¢ Based on MIT Pricing Engine principles
// ============================================================================
...
export function calculateOpportunityScore({
  ...
  const e = Math.min(Math.max(Math.abs(elasticity), 0), 3); // normalize 0â€“3
